...
#define _2p64  (unsigned __int128)(0x8000000000000000*2)
#define __bits128 __bits64, \
...
#if MAXSPECIES==64 
	bitcluster bcsingleton[MAXSPECIES] = { __bits64 };
#elif MAXSPECIES==128
	bitcluster bcsingleton[MAXSPECIES] = { __bits128 };
#else
